...
extension Image.DS.Icons: CaseIterable {
    ...
    public static let complete = Image(systemName: .DS.Icons.complete)

    /// SF symbol for "circle"
    public static let incomplete = Image(systemName: .DS.Icons.incomplete)

    /// SF symbol for "square.and.pencil"
    public static let create = Image(systemName: .DS.Icons.create)

    /// SF symbol for "square.and.arrow.up"
    public static let share = Image(systemName: .DS.Icons.share)

    /// SF symbol for "long.text.page.and.pencil"
    public static let edit = Image(systemName: .DS.Icons.edit)

    /// SF symbol for "trash"
    public static let delete = Image(systemName: .DS.Icons.delete)

    /// SF symbol for "microphone.fill"
    public static let dictate = Image(systemName: .DS.Icons.dictate)

    /// SF symbol for "magnifyingglass"
    public static let search = Image(systemName: .DS.Icons.search)
    ...
    public static let close = Image(systemName: .DS.Icons.close)
}
